...
import { idlFactory } from './DeFINetlySafeImage_frontend.did.js';
export { idlFactory } from './DeFINetlySafeImage_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DEFINETLYSAFEIMAGE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./DeFINetlySafeImage_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the DeFINetlySafeImage_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./DeFINetlySafeImage_frontend.did.js")._SERVICE>}
 */
export const DeFINetlySafeImage_frontend = createActor(canisterId);
