...
import { idlFactory } from './DeFINetlySafeImage_backend.did.js';
export { idlFactory } from './DeFINetlySafeImage_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DEFINETLYSAFEIMAGE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./DeFINetlySafeImage_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the DeFINetlySafeImage_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./DeFINetlySafeImage_backend.did.js")._SERVICE>}
 */
export const DeFINetlySafeImage_backend = createActor(canisterId);
